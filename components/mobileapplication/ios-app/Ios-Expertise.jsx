...
const IosExpertise = () => {
    ...
    const techCategories = {
        'Frontend': [
            { name: 'CircleCI', icon: <SiCircleci />, color: '#ffe367ff' },
            { name: 'CocoaPods', icon: <SiCocoapods />, color: '#7b18fdff' },
            { name: 'Objective-C', icon: <MdDataObject />, color: '#52fff6ff' },
            { name: 'Rxswift', icon: <RxAllSides />, color: '#3981daff' },
            { name: 'Swiftlint', icon: <FaSwift />, color: '#3981daff' },
            { name: 'Swiftui', icon: <SiBuildkite />, color: '#3981daff' },
        ],
        'Backend': [
